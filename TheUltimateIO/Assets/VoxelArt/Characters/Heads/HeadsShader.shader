...
Shader "TeamColorChangerShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float grayscale11 = Luminance(step( tex2DNode1 , float4( 1,0,0.06448603,1 ) ).rgb);
...
/*ASEBEGIN
Version=16700
1964;7;1350;790;1375.276;563.1603;1.486837;True;True
...
ASEEND*/
//CHKSM=2F93E8C6611306D741F6139CD53B157B5A4D93FF